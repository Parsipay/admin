    ...
    $applyStatusAndLevel = function (&$list, $type='general') {
        foreach ($list as &$Item) {
            ...
            if($type==='request'){
                ...
                switch($status){
                    case "موفق": $Item['StatusColor']="text-success opacity-green"; break;
                    case "پردازش": $Item['StatusColor']="text-warning bg-opacity-warning"; break;
                    case "رد شده": $Item['StatusColor']="text-danger opacity-danger"; break;
                    case "تکمیل نشده": $Item['StatusColor']="text-primary opacity-primary"; break;
                    default: $Item['StatusColor']="text-danger opacity-danger"; break;
                }
            }
            ...
            switch($level){
                case "طلایی": $Item['LevelIcon']="fa-solid fa-star text-warning"; break;
                case "حرفه ای": $Item['LevelIcon']="fa-solid fa-medal text-red"; break;
                case "فعال": $Item['LevelIcon']="fa-solid fa-circle-check text-green"; break;
                default: $Item['LevelIcon']="fa-solid fa-user text-primary"; break;
            }
        }
        unset($Item);
    };
